...
if not on:
    ...
    file_path = 'template_files/Python_Script_Code_Template.xlsx'

    excel_file_content = get_excel_file_content_as_binary(file_path)

    st.download_button(label="Download Python Script Code Template",
                    data=excel_file_content,
                    file_name="Python_Script_Code_Template.xlsx",
...
def describe_code_function(response, llm):
    ...
    full_prompt = f"""
        ...
        Think you as the Expert Automation Quality Assurance Engineer, Understand above given python api test script code. 
